...
import { callLLM, createLLMClient, type LLM } from "@crewai-ts/core/llm";
import { buildEmbedder } from "./rag.js";
import { BaseTool, type BaseToolOptions, type ToolArgsSchema } from "@crewai-ts/core/tools";
...
export class RecallMemoryTool extends BaseTool {
  ...
  constructor(options: Partial<BaseToolOptions> & { memory: Memory | MemoryScope | MemorySlice }) {
    super({
      ...
      description: options.description ?? "Search memory for relevant facts, decisions, and observations.",
...
export class RememberTool extends BaseTool {
  ...
  constructor(options: Partial<BaseToolOptions> & { memory: Memory | MemoryScope | MemorySlice }) {
    super({
      ...
      description: options.description ?? "Save durable facts, decisions, or observations to memory.",
