...
import { sanitizeToolName } from "@crewai-ts/core/tools";
import { MCPNativeTool, MCPToolWrapper } from "./tools.js";
import type { BaseTool } from "@crewai-ts/core/tools";
...
export class MCPClient {
  ...
  async connect(): Promise<this> {
    ...
    try {
      const client = new Client({ name: "@crewai-ts/mcp", version: "0.0.0" }, { capabilities: {} });
...
export { MCPNativeTool, MCPToolWrapper, type MCPNativeToolOptions, type MCPToolWrapperOptions } from "./tools.js";
