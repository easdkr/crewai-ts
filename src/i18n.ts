...
const defaultPrompts = {
  ...
  slices: {
    ...
    summarizer_system_message: "You summarize prior conversation context for a CrewAI agent. Preserve decisions, constraints, tool results, files, and unresolved questions.",
    summarize_instruction: "Summarize the following conversation. Return only the summary inside <summary></summary> tags.\n\n{conversation}",
