...
- Added A2A update-handler compatibility behavior:
  ...
  - A2A agent-card fetch failures now classify 401 responses as authentication failures and emit upstream-style authentication/connection error events.
