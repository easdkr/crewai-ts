...
4. Unified memory
   ...
   - These compatibility helpers are now present in the deterministic TS memory shim; remaining work is deeper executor-backed async writes and broader multi-action consolidation parity.
