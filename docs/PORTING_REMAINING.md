...
- OpenAI, Azure, Cohere, and Google Generative AI embedding providers now accept upstream legacy `model` config keys as `model_name` aliases while preserving explicit `model_name` precedence.
